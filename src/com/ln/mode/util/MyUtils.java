...
public class MyUtils {
    ...
    public static void storeLoginedUser(HttpSession session, UserAcction loginedUser) {
        // Trên JSP có thể truy cập thông qua ${loginedUser}
        session.setAttribute("loginedUser", loginedUser);
    }
 
    // Lấy thông tin người dùng lưu trữ trong Session.
    public static UserAcction getLoginedUser(HttpSession session) {
    	UserAcction loginedUser = (UserAcction) session.getAttribute("loginedUser");
        return loginedUser;
    }
 
    // Lưu thông tin người dùng vào Cookie.
    public static void storeUserCookie(HttpServletResponse response, UserAcction user) {
